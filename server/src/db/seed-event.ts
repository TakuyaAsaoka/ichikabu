...
/**
 * 開発中の表示確認に使うデータ（Issue #8）。
 *
 * 入れられるのは、使うと決めた出典で日付を
 ...
 * 読み直すときはブラウザで開く。
 *
 * 重要度は FOMC の3に対して2にした。★3だけを強調する表示で、
